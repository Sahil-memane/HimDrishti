...
export const AppLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { to: '/setup', label: 'Voyage', icon: 'sailing' },
  ...
  return (
    <div className="bg-[#071420] text-[#d7e4f5] font-sans min-h-screen flex overflow-hidden">
      ...
      <aside className="hidden md:flex fixed left-0 top-0 h-screen w-64 bg-[#14212d]/80 backdrop-blur-2xl border-r border-[#3c494e]/40 z-50 flex-col py-4 px-3 shadow-2xl">
        {/* Brand Header */}
        <div className="flex items-center gap-3 px-4 py-5 mb-4 border-b border-[#3c494e]/30">
          <div className="h-10 w-10 rounded-lg bg-[#aee9ff]/10 border border-[#aee9ff]/30 flex items-center justify-center text-[#aee9ff] flex-shrink-0">
        ...
        <button
          ...
          className="w-full bg-[#aee9ff]/10 text-[#aee9ff] border border-[#aee9ff]/30 hover:bg-[#aee9ff]/20 font-bold text-xs py-3 px-4 rounded mb-6 uppercase tracking-wider transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer shadow-[0_0_12px_rgba(174,233,255,0.15)]"
        >
        ...
        <nav className="flex-1 overflow-y-auto space-y-1.5">
          ...
          <NavLink
            to="/"
            className="flex items-center gap-3 px-4 py-3 rounded-lg text-xs font-semibold uppercase tracking-wider text-[#bbc9cf] hover:text-white hover:bg-[#1f2b38] transition-all"
          >
            <span className="material-symbols-outlined text-[20px]">landing</span>
            Landing View
          </NavLink>
        </nav>

        {/* User Operator Profile */}
        <div className="mt-auto pt-4 border-t border-[#3c494e]/30 flex items-center justify-between px-2">
          ...
          <button
            ...
            title="Logout"
            className="text-[#bbc9cf] hover:text-[#ffb4ab] transition-colors p-1"
          >
      ...
      {/* Top App Bar */}
      <header className="fixed top-0 right-0 left-0 md:left-64 h-16 bg-[#071420]/80 backdrop-blur-xl border-b border-[#3c494e]/40 z-40 flex items-center justify-between px-6">
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:flex items-center gap-2 px-3 py-1 rounded-full bg-[#101d29] border border-[#3c494e]/40">
        ...
        <div className="flex items-center gap-4 text-[#bbc9cf]">
          <button
            onClick={() => navigate('/setup')}
            className="hidden sm:flex items-center gap-2 bg-[#aee9ff] text-[#003543] font-bold text-xs px-4 py-2 rounded hover:bg-[#35d4ff] transition-all uppercase tracking-wider cursor-pointer"
          >
          ...
          <button
            ...
            className="relative hover:text-[#aee9ff] transition-colors p-1"
          >
